...
---
{{< figure src="/images/diffy.png" alt="AirGap-Diffy" width="120%" >}}
...
{{< figure src="/images/diffydemo.gif" alt="AirGap-Diffy generating a severity-sorted diff report" width="120%" >}}
